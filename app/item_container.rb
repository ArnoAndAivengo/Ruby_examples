module ItemContainer
  ...
  module InstanceMethods
    ...
    def method_missing(method_name)
      if method_name =~ /^all_/ # все методы начинаются на all_
  ...
  # Construct?
  # Callback метод расширяет класс ClassMethods методами класса и добавил instance методы в InstanceMethods
